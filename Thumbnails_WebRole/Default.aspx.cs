...
using System.Configuration;
///using Microsoft.WindowsAzure;
///using Microsoft.WindowsAzure.Diagnostics;  // Added
///using Microsoft.WindowsAzure.Storage.Auth;
///using Microsoft.WindowsAzure.Storage.Shared.Protocol;
using Microsoft.WindowsAzure.Storage;
///using Microsoft.WindowsAzure.Storage.Blob;
///using Microsoft.WindowsAzure.StorageClient;   // depricated
/// You're trying to add Microsoft.WindowsAzure.StorageClient.dll which is really-really old version of Storage Client library (thus not recommended). 
/// But if you're trying to get this DLL, try this link: http://www.nuget.org/packages/WindowsAzure.Storage/1.7.0
using Microsoft.WindowsAzure.ServiceRuntime;
*/
